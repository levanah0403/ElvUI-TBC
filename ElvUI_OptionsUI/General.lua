...
General.args.general.args.automation.args.autoRepair = ACH:Toggle(L["Auto Repair"], L["Automatically repair using the following method when visiting a merchant."], 5)
...
General.args.blizzUIImprovements.args.quest.args.objectiveTracker = ACH:Toggle(L["Objective Frame"], L["Enable"], 2)
