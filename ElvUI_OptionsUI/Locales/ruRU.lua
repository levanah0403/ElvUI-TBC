...
L["Alpha Fading"] = "Появление" --Check back later
...
L["AzeriteUI"] = "Азеритовые доспехи"
...
L["If enabled then the filter will only activate when the unit is controlled by the player."] = "Если включено, то фильтр будет активирован, когда юнит под вышим контролем."
...
L["If enabled then the filter will only activate when the unit is not controlled by the player."] = "Если включено, то фильтр будет активирован, когда юнит не под вышим контролем."
...
L["Reset Nameplate CVars to the ElvUI recommended defaults."] = "Сбросить CVar индикаторов на рекомендованые умолчания ElvUI."
...
L["Seconds"] = "Секунды"
L["Securely Tanking"] = "Уверенно танчим"
...
L["Set auras that are not from you to desaturad."] = "Иконки чужих аур будут обесцвечены."
...
L["Show Badge"] = "Отображать значек"
...
L["The durability percent that the datatext will start flashing.  Set to -1 to disable"] = "Процент прочности, при котором инфо-текст начнет мигать. Установите на -1 для отключения."
...
L["Not Owned By Player"] = "Не принадлежит вам"
...
L["FRIEND"] = "Друг";
L["FRIENDS"] = "Друзья";
L["GARRISON_CURRENT_LEVEL"] = "%d-й уровень";
...
L["NAME"] = "Имя";
L["NONE"] = "Нет";
L["NPC_NAMES_DROPDOWN_ALL"] = "Все NPC";
L["NPC_NAMES_DROPDOWN_TRACKED"] = "NPC, необходимые для заданий";
...
L["UNIT_NAMEPLATES_SHOW_ENEMY_MINIONS"] = "Прислужники";
L["UNIT_NAMEPLATES_SHOW_ENEMY_MINUS"] = "Незначительные NPC";
