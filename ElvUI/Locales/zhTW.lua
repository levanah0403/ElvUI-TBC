...
L["Bar "] = "快捷列 "
L["Bars"] = "條"
L["Battleground datatexts temporarily hidden, to show type /bgstats"] = "戰場資訊暫時隱藏, 輸入/bgstats顯示戰場資訊."
...
L["LOGIN_MSG"] = ("歡迎使用 *ElvUI TBC|r *%s 版本|r, 輸入 */ec|r 可打開遊戲內設置介面. 如果你需要技術協助, 可訪問我們的網址 https://www.tukui.org 或是加入我們的 Discord 伺服器: https://discord.gg/xFWcfgE"):gsub('*', E.InfoColor)
...
L["RL"] = "團長"
L["Role: Healer, Tank, Damage"] = "角色定位: 治療者, 坦克, 傷害輸出"
...
L["Waist"] = "腰部"
L["Welcome to ElvUI TBC version %.2f!"] = "歡迎使用 ElvUI TBC %.2f 版！"
L["whispers"] = "密語"
...
L["You can access the copy chat and chat menu functions by left/right clicking on the icon in the top right corner of the chat panel."] = "你可以點擊聊天面板的右上角圖示來複製對話紀錄, 及訪問聊天選單."
L["You can access the microbar by using middle mouse button on the minimap. You can also enable the MicroBar in the actionbar settings."] = "你可以在小地圖上右鍵點擊來開啟微型系統條. 你也可以在動作條設定中啟用微型系統條功能."
