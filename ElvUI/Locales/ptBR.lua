...
L["LOGIN_MSG"] = ("Bem-vindo ao *ElvUI TBC|r versão *%s|r, digite */ec|r para acessar as configurações dentro do jogo. Se você precisa de suporte técnico nos contate em https://www.tukui.org ou se entre no Discord: https://discord.gg/xFWcfgE"):gsub('*', E.InfoColor)
...
L["Waist"] = "Cintura"
L["Welcome to ElvUI TBC version %.2f!"] = "Bem-vindo à versão %.2f do ElvUI TBC!"
L["whispers"] = "sussurra"
